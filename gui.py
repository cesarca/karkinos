...
## Class MyFrame1
###########################################################################
from constants import INFORMATIVO, NO_INFORMATIVO
from karkinos import Karkinos
...
class MyFrame1(wx.Frame):
    ...
    def __load_gui(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY,
                          title=u"Karkínos - Sistema de Ayuda a la Decisión para la evaluación del riesgo de cáncer genético",
                          pos=wx.DefaultPosition, size=wx.Size(950, 550),
        ...
        self.text_indice = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                       wx.TE_READONLY)
        ...
        self.label_informativo = wx.StaticText(self, wx.ID_ANY, u"Informativo - No Informativo", wx.DefaultPosition,
                                               wx.DefaultSize, 0)
        ...
        self.text_informativo = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
        ...
        self.text_asociados = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                          wx.TE_MULTILINE | wx.TE_READONLY)
        ...
        self.text_diagnostico = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                            wx.TE_MULTILINE | wx.TE_READONLY)
    ...
    def __informativo(self, karkinos):
        return INFORMATIVO if karkinos.diagnosis()[1].get_informatives() else NO_INFORMATIVO

    def __index_case(self, karkinos, patient):
        texto, paciente = karkinos.index_case(patient.relatives)
        return texto + " : " + paciente.display_name

    def __casos_asociados(self, karkinos):
        return "\n".join(["Nodo: " + ca.display_name for ca in karkinos.diagnosis()[1].get_associated()])

    def __diagnosis(self, karkinos):
        return karkinos.diagnosis()[0]
